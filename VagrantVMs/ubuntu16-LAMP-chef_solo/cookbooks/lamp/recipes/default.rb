...
execute "sudo echo 'mysql-server mysql-server/root_password admin' | debconf-set-selections"
execute "sudo echo 'mysql-server mysql-server/root_password_again admin' | debconf-set-selections"
